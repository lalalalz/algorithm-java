...
public class Solution {
    ...
    public int solution(int[] bandage, int health, int[][] attacks) {
        ...
        for (int[] attack : attacks) {
            ...
            int countOfFullRecovery = (attackTime - currentTime) / castTime;
            int countOfRecovery = (attackTime - currentTime) % castTime;
            int totalRecovery = (recoveryPerSec * castTime + additionalRecovery) * countOfFullRecovery
                    + countOfRecovery * recoveryPerSec;

            currentHealth = Math.min(totalRecovery + currentHealth, health);
